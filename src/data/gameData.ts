...
export const MENU_ITEMS: Record<string, MenuItem> = {
  ...
  cheeseburger: {
    ...
    cookedEmoji: '🍕',
    rawNameTh: 'ชีสสด',
    cookedNameTh: 'พิซซ่าชีส',
    cookTime: 7,
    burnTime: 7,
    score: 110,
    coins: 30,
    speechPhraseEn: 'A hot slice of delicious Cheese Pizza, please!',
    descriptionTh: 'พิซซ่าแป้งบางกรอบ โปะชีสเยิ้มๆ หอมกรุ่นจากเตา',
  },
  chicken_nuggets: {
    id: 'chicken_nuggets',
...
export const GAME_LEVELS: LevelConfig[] = [
  ...
  },
  {
    ...
    icon: '🍔',
    descriptionTh: 'เพิ่มความเร็วด้วยเบอร์เกอร์เนื้อชุ่มฉ่ำ เฟรนช์ฟรายส์กรอบ และพิซซ่าชีส',
    days: [
      {
        dayNumber: 1,
        durationSeconds: 80,
